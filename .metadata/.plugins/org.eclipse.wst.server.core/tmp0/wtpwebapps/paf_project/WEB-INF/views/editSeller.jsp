				...
				<div class="col-md-8">
					<div class="card">
						<div align="center" class="card-header">
							...
							<a href="/paf_project/deletePermanentSeller"><button class="btn btn-primary" style="box-shadow:none;">Deactivate Permanent</button></a>
						</div>

						<div class="card-body">
							<form:form id="myForm" method="post"
								action="/paf_project/editSaveSeller" modelAttribute="seller">

								<div class="form-group row">
									<div class="col-md-6">
										<form:input type="text" path="suppID" class="form-control"
											name="sID" required="required" hidden="hidden"
											autofocus="autofocus" />
									</div>
								</div>
