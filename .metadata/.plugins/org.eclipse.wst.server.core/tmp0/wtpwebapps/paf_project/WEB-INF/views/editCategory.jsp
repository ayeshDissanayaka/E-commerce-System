			...
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						...
						<div class="card-body">
							<form:form method="post" action="/paf_project/editSaveCategory"
								modelAttribute="category">

								
									<div class="col-md-6">
										<form:input type="text" path="catID" class="form-control"
											name="cID" required="required" hidden = "hidden" autofocus="autofocus" />
									</div>
								</div>
