				...
				<div class="col-md-8">
					<div class="card">
						<div align="center" class="card-header">
							<h4>
								<b>Edit Shipping Form</b>
								
							</h4>
						</div>
						<div class="card-body">
							<form:form method="post" action="/paf_project/editSaveShipping"
								modelAttribute="shipping">

								
									<div class="col-md-6">
										<form:input type="text" path="shipID" class="form-control"
											name="sID" required="required" hidden = "hidden" autofocus="autofocus" />
									</div>
								</div>
								
								<div class="form-group row">
									<label for="email_address"
										class="col-md-4 col-form-label text-md-right"><h4>Company Name
											</h4></label>
									<div class="col-md-6">
